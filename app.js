...
const DEFAULT_SANTRI_MASTER = [
  ...
  { no: 15, nama: "Afiqah Nadhira Salsabila", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 16, nama: "Zahira Octavia Suanto", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 17, nama: "Annisa Amira Azzahra", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 18, nama: "Nayka Alya", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 19, nama: "Talita ufaira", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 20, nama: "Zahida Rosyifa Nadhifa", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 21, nama: "Afifa Fitiya", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 22, nama: "Desi Humaira Syahputri", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 23, nama: "Nayla Husna Aulia", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 24, nama: "Aila Zulfa Fauziyah", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 25, nama: "Alya Yassirni Syarifah", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 26, nama: "Asyifa Husna", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },
  { no: 27, nama: "Azzahra Putri Almesya", gender: "P", tingkat: "2A PUTRI (Wustho 1)", pembina: "Ayu Maulida Tsamrotul Jannah, S.Sos" },

  // 2B PUTRI (Wustho 1) - Pembina: Wildan Arifin, M.Hum
  { no: 30, nama: "Aila Zulfa Fauziah", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 31, nama: "Alya Yassirni Syarifah", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 32, nama: "Asyifa Husna", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 33, nama: "Azzahra Putri Almesya", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 34, nama: "Elsa Mardhiana", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 35, nama: "Haura Azkia Ramadhani", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 36, nama: "Jelita Az Zahra", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 37, nama: "Fadillah Yasmin", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 38, nama: "Malca Khairana", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 40, nama: "Nazwa Kirana", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 41, nama: "Salwa Khairunnisa", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 42, nama: "Tami Dawa Fuadi Jaelani", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  { no: 43, nama: "Zahira Yumna Aufarachma", gender: "P", tingkat: "2B PUTRI (Wustho 1)", pembina: "Wildan Arifin, S.Hum" },
  ...
  { no: 58, nama: "AQYLLAH FARRASYAH ZHAFIRA", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 59, nama: "AULIA BILQIS SUDARNO", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 60, nama: "AULIA NUR AZIMAH ASHIHAB", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 61, nama: "DHIA AMALIA PUTRI WIYONO", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 62, nama: "Denasya Nur Shafiya Putri", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 63, nama: "HASNA SHAFAA' NAFISAH", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 64, nama: "KELUAR Mega Octaviani", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 65, nama: "MUTIARA AZZAHRA ROHYANA", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 66, nama: "Nabila Esa Lestari", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 67, nama: "KELUAR Nakheisya Saky Hafizah", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 68, nama: "KELUAR Regina Aulia Oktavia", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 69, nama: "SHAFA AULIA KAMILA", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
  { no: 70, nama: "Vina Ramadhani", gender: "P", tingkat: "4 PUTRI (ULYA 1)", pembina: "M. Mujabun, M.Pd" },
